...
import { AlertTriangle, Lock, CheckCircle2, RefreshCw } from 'lucide-react';
...
export default function StatusBanner({ status, reason, onRefresh }: StatusBannerProps) {
  ...
  return (
    <AnimatePresence>
      ...
      >
        <div className="glass metropolis-glow p-4 rounded-2xl border border-red-500/30 bg-red-950/20 backdrop-blur-xl flex items-center justify-between gap-6 shadow-[0_0_30px_rgba(239,68,68,0.15)]">

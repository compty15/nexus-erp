...
import { flashScan, calculateBurnRate, ModelType, fetchImageWithRetry } from '@/lib/gemini';
...
export async function POST(req: NextRequest) {
  try {
    ...
    const mediaParts = fetchResults.filter((r): r is NonNullable<typeof r> => r !== null);

...
export default function FinanceGauge({ 
  ...
  return (
    <div className="glass bg-card rounded-3xl p-6 relative overflow-hidden group transition-all hover:bg-zinc-900/50 min-h-[220px] border border-border flex flex-col justify-between">
        ...
        <div className="flex items-center gap-6">
          <div className="relative w-20 h-20">
             <svg className="w-full h-full -rotate-90 transform">
                <circle cx="40" cy="40" r={radius} stroke="currentColor" strokeWidth="4" fill="transparent" className="text-zinc-950" />
                <motion.circle 

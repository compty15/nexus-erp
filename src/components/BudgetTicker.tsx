...
export default function BudgetTicker({ balance }: BudgetTickerProps) {
  ...
  return (
    <div className="glass bg-card p-4 rounded-2xl flex items-center gap-6 overflow-hidden relative border border-border">
      <div className="flex items-center gap-2 px-4 py-2 bg-zinc-950 rounded-xl border border-border z-10 shrink-0">
